  ...
  const services = [
    {
      ...
      description: 'Проведение глубокого исследования рынка, изучение конкурентов и создание персонализированной стратегии для вашего бизнеса. Определяем целевую аудиторию, строим эффективную воронку продаж и разрабатываем уникальное торговое предложение.'
    },
    {
      id: 'branding',
      title: 'Брендирование',
      ...
      description: 'Создание запоминающегося бренда от нейминга до полного фирменного стиля. Разрабатываем логотип, цветовую палитру, шрифты и визуальные элементы. Создаем брендбук с четкими правилами использования и легенду бренда для эмоциональной связи с аудиторией.'
    },
    {
      id: 'digital',
      ...
      description: 'Создание современных сайтов с удобной навигацией и быстрой загрузкой. Проводим SEO-оптимизацию для высоких позиций в поисковых системах. Разрабатываем интуитивные интерфейсы и создаем прототипы в Figma для тестирования идей.'
    },
    {
      id: 'smm',
      title: 'SMM и контент',
      ...
      description: 'Разработка стратегии контента и его регулярное создание. Профессиональная фото- и видеосъемка, написание текстов, создание инфографики. Ведение соцсетей с повышением вовлеченности и ростом аудитории через качественный контент.'
    },
    {
      id: 'ads',
      title: 'Реклама',
      ...
      description: 'Запуск эффективных рекламных кампаний в соцсетях и поисковых системах. Точное таргетирование по аудитории, оптимизация бюджета и анализ результатов. Построение PR-стратегии для укрепления репутации и работы с медиа.'
    },
    {
      id: 'crm',
      title: 'CRM-системы',
      ...
      description: 'Внедрение и настройка CRM-системы под ваши бизнес-процессы. Интеграция с сайтом, соцсетями и другими инструментами. Автоматизация рутинных задач, сбора лидов и отправки уведомлений для повышения эффективности продаж.'
    }
  ];
              ...
              >
                ...
                <CardContent>
                  <div className={`overflow-hidden transition-all duration-300 ${
                    activeService === service.id ? 'max-h-[500px]' : 'max-h-0'
                  }`}>
                    <div className="mb-4">
